import{j as e}from"./react-vendor.Bbij9VJV.js";import{S as i}from"./SEO.BsB9VG9F.js";import{S as o}from"./ScrollAnimation.B3kqn4gp.js";import{u as s}from"./index.C9cTYGmD.js";import"./vendor.DPtWTE78.js";const u=()=>{const{lang:a}=s(),t={bn:`টার্মস অ্যান্ড কন্ডিশনস
...
🌐 Website: kafaah.com`};return e.jsxs("div",{className:"min-h-screen bg-geometric-light dark:bg-geometric-dark py-16 px-4",children:[e.jsx(i,{title:a==="bn"?"ব্যবহারের শর্তাবলী":"Terms & Conditions",description:a==="bn"?"কাফআহ ওয়েবসাইট ও অ্যাপ ব্যবহারের শর্তাবলী। ইউজার অ্যাকাউন্ট, তথ্যের নিরাপত্তা, মেধাস্বত্ব সংক্রান্ত তথ্য।":"Terms and conditions for using Kafa'ah website and app. User account, data security, intellectual property.",url:"https://kafaahbd.com/terms-conditions"}),e.jsx("div",{className:"max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg",children:e.jsx(o,{children:e.jsx("div",{className:"prose prose-lg dark:prose-invert max-w-none",children:e.jsx("p",{className:"whitespace-pre-line text-gray-800 dark:text-gray-200",children:a==="bn"?t.bn:t.en})})})})]})};export{u as default};
