import{j as e}from"./react-vendor.Bbij9VJV.js";import{S as i}from"./SEO.BsB9VG9F.js";import{S as r}from"./ScrollAnimation.B3kqn4gp.js";import{u as t}from"./index.C9cTYGmD.js";import"./vendor.DPtWTE78.js";const m=()=>{const{lang:o}=t(),a={bn:`Privacy & Policy
...
📧 Email: tanvirishrak04@gmail.com
📍 Address: Rajshahi
📞 Phone: 01770676700`};return e.jsxs("div",{className:"min-h-screen bg-geometric-light dark:bg-geometric-dark py-16 px-4",children:[e.jsx(i,{title:o==="bn"?"গোপনীয়তা নীতি":"Privacy Policy",description:o==="bn"?"কাফআহ ওয়েবসাইট ও অ্যাপের গোপনীয়তা নীতি। আপনার তথ্য কীভাবে সংগ্রহ ও ব্যবহার করা হয় তা জানুন।":"Privacy policy of Kafa'ah website and app. Learn how we collect and use your information.",url:"https://kafaahbd.com/privacy-policy"}),e.jsx("div",{className:"max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg",children:e.jsx(r,{children:e.jsx("div",{className:"prose prose-lg dark:prose-invert max-w-none",children:e.jsx("p",{className:"whitespace-pre-line text-gray-800 dark:text-gray-200",children:o==="bn"?a.bn:a.en})})})})]})};export{m as default};
