import{j as e,d as t}from"./react-vendor.DpIp4ypX.js";import{S as i}from"./ScrollAnimation.BSJo7J5w.js";import{u as r}from"./index.CAEp_tRF.js";import"./vendor.1InCdCzI.js";const d=()=>{const{lang:o}=r(),a={bn:`Privacy & Policy
...
📍 Address: Rajshahi
📞 Phone: 01770676700`,en:`Privacy & Policy
...
📧 Email: tanvirishrak04@gmail.com
📍 Address: Rajshahi
📞 Phone: 01770676700`};return e.jsxs("div",{className:"min-h-screen bg-geometric-light dark:bg-geometric-dark py-16 px-4",children:[e.jsxs(t,{children:[o==="bn"?e.jsxs(e.Fragment,{children:[e.jsx("title",{children:"গোপনীয়তা নীতি - কাফআহ"}),e.jsx("meta",{name:"description",content:"কাফআহ ওয়েবসাইট ও অ্যাপের গোপনীয়তা নীতি। আপনার তথ্য কীভাবে সংগ্রহ ও ব্যবহার করা হয় তা জানুন।"}),e.jsx("meta",{property:"og:title",content:"গোপনীয়তা নীতি - কাফআহ"}),e.jsx("meta",{property:"og:description",content:"কাফআহ-এর গোপনীয়তা নীতি ও শর্তাবলী।"})]}):e.jsxs(e.Fragment,{children:[e.jsx("title",{children:"Privacy Policy - Kafa'ah"}),e.jsx("meta",{name:"description",content:"Privacy policy of Kafa'ah website and app. Learn how we collect and use your information."}),e.jsx("meta",{property:"og:title",content:"Privacy Policy - Kafa'ah"}),e.jsx("meta",{property:"og:description",content:"Kafa'ah's privacy policy and terms."})]}),e.jsx("meta",{property:"og:url",content:"https://kafaahbd.github.io/kafaahbd/privacy-policy"})]}),e.jsx("div",{className:"max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg",children:e.jsx(i,{children:e.jsx("div",{className:"prose prose-lg dark:prose-invert max-w-none",children:e.jsx("p",{className:"whitespace-pre-line text-gray-800 dark:text-gray-200",children:o==="bn"?a.bn:a.en})})})})]})};export{d as default};
