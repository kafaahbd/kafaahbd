import{j as e,d as o}from"./react-vendor.DpIp4ypX.js";import{S as s}from"./ScrollAnimation.BSJo7J5w.js";import{u as i}from"./index.CAEp_tRF.js";import"./vendor.1InCdCzI.js";const m=()=>{const{lang:a}=i(),t={bn:`টার্মস অ্যান্ড কন্ডিশনস
...
🌐 ওয়েবসাইট: kafaah.com`,en:`Terms and Conditions
...
🌐 Website: kafaah.com`};return e.jsxs("div",{className:"min-h-screen bg-geometric-light dark:bg-geometric-dark py-16 px-4",children:[e.jsxs(o,{children:[a==="bn"?e.jsxs(e.Fragment,{children:[e.jsx("title",{children:"ব্যবহারের শর্তাবলী - কাফআহ"}),e.jsx("meta",{name:"description",content:"কাফআহ ওয়েবসাইট ও অ্যাপ ব্যবহারের শর্তাবলী। ইউজার অ্যাকাউন্ট, তথ্যের নিরাপত্তা, মেধাস্বত্ব সংক্রান্ত তথ্য।"}),e.jsx("meta",{property:"og:title",content:"ব্যবহারের শর্তাবলী - কাফআহ"}),e.jsx("meta",{property:"og:description",content:"কাফআহ সেবা ব্যবহারের শর্তাবলী।"})]}):e.jsxs(e.Fragment,{children:[e.jsx("title",{children:"Terms & Conditions - Kafa'ah"}),e.jsx("meta",{name:"description",content:"Terms and conditions for using Kafa'ah website and app. User account, data security, intellectual property."}),e.jsx("meta",{property:"og:title",content:"Terms & Conditions - Kafa'ah"}),e.jsx("meta",{property:"og:description",content:"Terms of service for Kafa'ah."})]}),e.jsx("meta",{property:"og:url",content:"https://kafaahbd.github.io/kafaahbd/terms-conditions"})]}),e.jsx("div",{className:"max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg",children:e.jsx(s,{children:e.jsx("div",{className:"prose prose-lg dark:prose-invert max-w-none",children:e.jsx("p",{className:"whitespace-pre-line text-gray-800 dark:text-gray-200",children:a==="bn"?t.bn:t.en})})})})]})};export{m as default};
