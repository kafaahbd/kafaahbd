// src/data/subjectChapters.js
// এখানে সব গ্রুপ ও সাবজেক্টের অধ্যায়ের তালিকা সংরক্ষিত থাকবে
export const subjectChapters = {
  ...
  ssc: {
    ...
    ict: [
      { name: 'ICT অধ্যায় ১', url: '#' },
    ],
    math: [
      { name: 'সাধারণ গণিত অধ্যায় ১', url: '#' },
    ],
    islam: [
      { name: 'ইসলাম শিক্ষা অধ্যায় ১', url: '#' },
    ],
    // Science
    physics: [
    ...
    biology: [
      { name: 'জীববিজ্ঞান অধ্যায় ১', url: '#' },
    ],
    // Arts
    history: [
      { name: 'ইতিহাস অধ্যায় ১', url: '#' },
    ],
    civics: [
      { name: 'পৌরনীতি অধ্যায় ১', url: '#' },
    ],
    geography: [
      { name: 'ভূগোল অধ্যায় ১', url: '#' },
    ],
    // Commerce
    accounting: [
      { name: 'হিসাববিজ্ঞান অধ্যায় ১', url: '#' },
    ],
    business: [
      { name: 'ব্যবসায় উদ্যোগ অধ্যায় ১', url: '#' },
    ],
    finance: [
      { name: 'ফাইন্যান্স অধ্যায় ১', url: '#' },
    ],
    // Optional
    highermath: [
      { name: 'উচ্চতর গণিত অধ্যায় ১', url: '#' },
    ],
    agriculture: [
      { name: 'কৃষি শিক্ষা অধ্যায় ১', url: '#' },
    ],
    health: [
      { name: 'স্বাস্থ্য বিজ্ঞান অধ্যায় ১', url: '#' },
    ],
  },
  ...
  hsc: {
    ...
    highermath: [
      { name: 'উচ্চতর গণিত ১ম পত্র অধ্যায় ১', url: '#' },
    ],
    // Arts
    history: [
      { name: 'ইতিহাস অধ্যায় ১', url: '#' },
    ...
    islamic: [
      { name: 'ইসলামের ইতিহাস অধ্যায় ১', url: '#' },
    ],
    civics: [
      { name: 'পৌরনীতি অধ্যায় ১', url: '#' },
    ],
    economics: [
      { name: 'অর্থনীতি অধ্যায় ১', url: '#' },
    ],
    geography: [
      { name: 'ভূগোল অধ্যায় ১', url: '#' },
    ],
    ...
    management: [
      { name: 'ব্যবস্থাপনা অধ্যায় ১', url: '#' },
    ],
    finance: [
      { name: 'ফাইন্যান্স অধ্যায় ১', url: '#' },
    ],
    business: [
      { name: 'ব্যবসায় সংগঠন অধ্যায় ১', url: '#' },
    ],
    marketing: [
      { name: 'মার্কেটিং অধ্যায় ১', url: '#' },
    ],
  },
  ...
  admission: {
    ...
    'engineering-math': [
      { name: 'গণিত (ইঞ্জিনিয়ারিং) অধ্যায় ১', url: '#' },
    ],
    'engineering-highermath': [
      { name: 'উচ্চতর গণিত (ইঞ্জিনিয়ারিং) অধ্যায় ১', url: '#' },
    ],
    'medical-physics': [
      { name: 'পদার্থ (মেডিকেল) অধ্যায় ১', url: '#' },
    ],
    'medical-chemistry': [
      { name: 'রসায়ন (মেডিকেল) অধ্যায় ১', url: '#' },
    ],
    'medical-biology': [
      { name: 'জীববিজ্ঞান (মেডিকেল) অধ্যায় ১', url: '#' },
    ],
    'university-bangla': [
      { name: 'বাংলা (বিশ্ববিদ্যালয়) অধ্যায় ১', url: '#' },
    ],
    'university-english': [
      { name: 'ইংরেজি (বিশ্ববিদ্যালয়) অধ্যায় ১', url: '#' },
    ],
    'university-gk': [
      { name: 'সাধারণ জ্ঞান অধ্যায় ১', url: '#' },
    ],
  },
};