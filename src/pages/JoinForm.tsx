...
const JoinForm: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen relative bg-slate-50/60 dark:bg-[#070c12] text-gray-800 dark:text-gray-100 transition-colors duration-500 font-sans pb-28 selection:bg-emerald-500 selection:text-white">
      {/* Background Gradients */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-[10%] -right-[10%] w-[50vw] h-[50vw] bg-emerald-500/10 dark:bg-emerald-900/20 blur-[140px] rounded-full" />
        <div className="absolute top-[35%] -left-[10%] w-[45vw] h-[45vw] bg-teal-500/10 dark:bg-teal-900/20 blur-[130px] rounded-full" />
        <div className="absolute -bottom-[10%] right-[15%] w-[40vw] h-[40vw] bg-cyan-500/10 dark:bg-cyan-900/20 blur-[140px] rounded-full" />
      </div>

      <div className="relative z-10 pt-8 px-4 sm:px-6 max-w-4xl mx-auto">
        {/* Top Header Navigation */}
        <div className="mb-6 flex flex-wrap gap-3 justify-between items-center bg-white/70 dark:bg-[#101720]/70 backdrop-blur-md p-4 rounded-2xl border border-gray-200/60 dark:border-white/10 shadow-sm">
          <Breadcrumb items={[{ name: isBn ? "আবেদন ফরম" : "Join Application Form" }]} />
          <span className="text-xs font-bold px-3.5 py-1.5 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 rounded-full border border-emerald-500/20 flex items-center gap-1.5">
        ...
        {/* Hero Form Header */}
        <div className="bg-gradient-to-br from-emerald-800 via-teal-800 to-emerald-900 text-white p-8 md:p-12 rounded-3xl shadow-2xl mb-10 relative overflow-hidden border border-emerald-700/50">
          <div className="absolute -right-10 -bottom-10 w-64 h-64 bg-white/5 rounded-full blur-2xl pointer-events-none" />
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md text-emerald-200 text-xs font-bold uppercase tracking-wider mb-5 border border-white/15 shadow-inner">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4 text-transparent bg-clip-text bg-gradient-to-r from-white via-emerald-100 to-teal-100">
              {isBn ? "কাফআহ টিমে যোগ দেওয়ার আবেদন" : "Join Team Kafa'ah Application"}
            </h1>
            <p className="text-emerald-100/90 text-sm md:text-base max-w-2xl leading-relaxed font-medium">
              {isBn 
        ...
        <AnimatePresence mode="wait">
          {isSuccess ? (
            <motion.div
              ...
              className="bg-white/80 dark:bg-[#101720]/90 backdrop-blur-xl border border-emerald-500/30 rounded-3xl p-10 md:p-16 text-center max-w-2xl mx-auto shadow-2xl space-y-6"
            >
              <div className="w-20 h-20 bg-gradient-to-tr from-emerald-500 to-teal-400 text-white rounded-2xl flex items-center justify-center mx-auto shadow-lg shadow-emerald-500/30 rotate-3">
              ...
              <div className="pt-4">
                <button 
                  ...
                  className="px-8 py-3.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-2xl font-bold transition-all shadow-lg shadow-emerald-600/30 hover:scale-[1.02] active:scale-[0.98]"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              {errorMessage && (
                <motion.div 
                  ...
                  className="p-4 bg-rose-500/10 border border-rose-500/30 backdrop-blur-md rounded-2xl text-rose-600 dark:text-rose-400 text-sm font-semibold flex items-center gap-3 shadow-sm"
                >
              ...
              <motion.section 
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="bg-white/80 dark:bg-[#101720]/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-gray-200/80 dark:border-white/10 shadow-xl shadow-gray-200/20 dark:shadow-none space-y-6"
              >
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50 dark:bg-[#161f2c] border border-gray-200 dark:border-white/10 rounded-2xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-[#1a2535] transition-all outline-none font-medium"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full bg-slate-50 dark:bg-[#161f2c] border border-gray-200 dark:border-white/10 rounded-2xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-[#1a2535] transition-all outline-none font-medium cursor-pointer"
                    >
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="relative group border-2 border-dashed border-gray-300 dark:border-white/15 hover:border-emerald-500 dark:hover:border-emerald-500 transition-colors bg-slate-50/50 dark:bg-[#161f2c]/50 p-5 rounded-2xl flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
                      {imagePreview ? (
                        <div className="relative shrink-0">
                          <img src={imagePreview} alt="Preview" className="w-20 h-20 rounded-2xl object-cover border-2 border-emerald-500 shadow-md" />
                        </div>
                      ) : (
                        <div className="w-16 h-16 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-2xl flex items-center justify-center shrink-0">
                          <ImageIcon size={30} />
                        </div>
                      )}
                      <div className="flex-1 space-y-1">
                        <div className="text-xs font-bold text-gray-700 dark:text-gray-200">
                          {isBn ? "ছবি সিলেক্ট বা ড্র্যাগ অ্যান্ড ড্রপ করুন" : "Upload profile photo"}
                        </div>
                        <p className="text-[11px] text-gray-400">
                          {isBn ? "PNG অথবা JPG, সর্বোচ্চ সাইজ ৫ মেগাবাইট" : "PNG or JPG format, max 5MB size."}
                        </p>
                        <input 
                          type="file" 
                          accept="image/*" 
                          onChange={handleImageChange}
                          className="mt-2 text-xs text-gray-500 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-emerald-600 file:text-white hover:file:bg-emerald-500 cursor-pointer"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="relative group border-2 border-dashed border-gray-300 dark:border-white/15 hover:border-teal-500 dark:hover:border-teal-500 transition-colors bg-slate-50/50 dark:bg-[#161f2c]/50 p-5 rounded-2xl flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
                      <div className="w-16 h-16 bg-teal-500/10 text-teal-600 dark:text-teal-400 rounded-2xl flex items-center justify-center shrink-0">
                        <UploadCloud size={30} />
                      </div>
                      <div className="flex-1 overflow-hidden space-y-1">
                        <div className="text-xs font-bold text-gray-700 dark:text-gray-200 truncate">
                          {cvFile ? cvFile.name : (isBn ? "সিভি সিলেক্ট করুন" : "Upload your resume file")}
                        </div>
                        <p className="text-[11px] text-gray-400 truncate">
                          {isBn ? "PDF বা DOCX ফাইল, সর্বোচ্চ ১০ মেগাবাইট" : "PDF or DOCX format, max 10MB."}
                        </p>
                        <input 
                          type="file" 
                          accept=".pdf,.doc,.docx" 
                          onChange={handleCvChange}
                          className="mt-2 text-xs text-gray-500 file:mr-3 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-teal-600 file:text-white hover:file:bg-teal-500 cursor-pointer"
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <input 
                      ...
                      required
                      className="bg-slate-50 dark:bg-[#161f2c] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-xs focus:ring-2 focus:ring-emerald-500 outline-none font-medium"
                    />
                    <input 
                      type="text" 
                  ...
                  <div className="pt-2 flex items-center gap-3">
                    <input 
                      ...
                      className="w-4 h-4 text-emerald-600 rounded-md focus:ring-emerald-500 cursor-pointer border-gray-300"
                    />
                    <label htmlFor="sameAsPresent" className="text-xs font-semibold text-gray-700 dark:text-gray-300 cursor-pointer select-none">
              ...
              >
                ...
                {/* Non-Muslim Switch */}
                <div className="p-5 bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent border border-amber-500/20 rounded-2xl flex items-center justify-between gap-4">
                  <div>
                        ...
                        <button
                          ...
                          className={`px-4 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 cursor-pointer ${
                            isSelected 
                              ...
                              : "bg-slate-100 dark:bg-white/5 text-gray-700 dark:text-gray-300 hover:bg-emerald-500/10 hover:text-emerald-600 border border-transparent dark:hover:border-emerald-500/20"
                          }`}
                        >
                    ...
                    <div className="pt-6 border-t border-gray-100 dark:border-white/5 space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        {selectedSkills.map(skill => (
                          <div key={skill} className="flex items-center justify-between p-3.5 bg-slate-50 dark:bg-[#161f2c] rounded-2xl border border-gray-200/60 dark:border-white/5">
                            <span className="text-xs font-bold truncate max-w-[170px]">{skill}</span>
                            <div className="flex items-center gap-1 bg-white dark:bg-black/20 p-1.5 rounded-xl border border-gray-200/50 dark:border-white/5">
                              {[1, 2, 3, 4, 5].map(star => (
                                <button
                                  key={star}
                                  type="button"
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-slate-50 dark:bg-[#161f2c] border border-gray-200 dark:border-white/10 rounded-2xl px-4 py-3.5 text-sm focus:ring-2 focus:ring-emerald-500 focus:bg-white dark:focus:bg-[#1a2535] transition-all outline-none font-medium resize-none"
                    />
                  </div>
              ...
              {/* SECTION 10: SOCIAL & PROFESSIONAL LINKS */}
              <motion.section 
                variants={containerVariants}
                initial="hidden"
                whileInView="visible"
              ...
              <motion.section 
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className="bg-white/80 dark:bg-[#101720]/80 backdrop-blur-xl p-6 md:p-8 rounded-3xl border border-emerald-500/30 shadow-xl shadow-emerald-500/5 space-y-6"
              >
                <div className="flex items-center gap-3 border-b border-gray-100 dark:border-white/10 pb-4">
                  <div className="p-3 bg-emerald-500/10 rounded-2xl text-emerald-600 dark:text-emerald-400">
                    <ShieldCheck size={22} />
                ...
                <div className="space-y-4">
                  <div className="p-5 bg-emerald-500/5 border border-emerald-500/20 rounded-2xl text-xs text-gray-700 dark:text-gray-300 leading-relaxed space-y-2">
                  ...
                  <div className="flex items-start gap-3 pt-2">
                    <input 
                      ...
                      onChange={handleInputChange} 
                      required 
                      className="mt-1 w-4 h-4 text-emerald-600 rounded-md focus:ring-emerald-500 cursor-pointer border-gray-300"
                    />
                    <label htmlFor="agreedToTerms" className="text-xs font-semibold text-gray-800 dark:text-gray-200 cursor-pointer select-none">
                      {isBn 
                  ...
                  <div className="flex items-start gap-3">
                    <input 
                      ...
                      className="mt-1 w-4 h-4 text-emerald-600 rounded-md focus:ring-emerald-500 cursor-pointer border-gray-300"
                    />
                    <label htmlFor="truthDeclaration" className="text-xs font-semibold text-gray-800 dark:text-gray-200 cursor-pointer select-none">
                      {isBn 
              ...
              <div className="pt-4">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:from-emerald-500 hover:to-teal-500 text-white py-4.5 rounded-2xl font-black text-lg md:text-xl shadow-xl shadow-emerald-600/30 flex items-center justify-center gap-3 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-60 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
