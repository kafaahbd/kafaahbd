  ...
  const groups: Group[] = [
    {
      ...
      subjects: [
        {
          name: t("study.hsc.subjects.bangla"),
          path: "/study/exam?group=hsc&subject=bangla",
        },
        {
          name: t("study.hsc.subjects.english"),
          path: "/study/exam?group=hsc&subject=english",
        },
        {
          name: t("study.hsc.subjects.ict"),
          path: "/study/exam?group=hsc&subject=ict",
        },
      ],
    },
    {
      ...
      subjects: [
        {
          name: t("study.hsc.subjects.physics"),
          path: "/study/exam?group=hsc&subject=physics",
        },
        {
          name: t("study.hsc.subjects.chemistry"),
          path: "/study/exam?group=hsc&subject=chemistry",
        },
        {
          name: t("study.hsc.subjects.biology"),
          path: "/study/exam?group=hsc&subject=biology",
        },
        {
          name: t("study.hsc.subjects.highermath"),
          path: "/study/exam?group=hsc&subject=highermath",
        },
      ],
    },
    {
      ...
      subjects: [
        {
          ...
          path: "/study/exam?group=hsc&subject=history",
        },
        {
          name: t("study.hsc.subjects.islamic"),
          path: "/study/exam?group=hsc&subject=islamic",
        },
        {
          name: t("study.hsc.subjects.civics"),
          path: "/study/exam?group=hsc&subject=civics",
        },
        {
          name: t("study.hsc.subjects.economics"),
          path: "/study/exam?group=hsc&subject=economics",
        },
        {
          name: t("study.hsc.subjects.geography"),
          path: "/study/exam?group=hsc&subject=geography",
        },
      ],
    },
    {
      ...
      subjects: [
        {
          name: t("study.hsc.subjects.accounting"),
          path: "/study/exam?group=hsc&subject=accounting",
        },
        {
          name: t("study.hsc.subjects.management"),
          path: "/study/exam?group=hsc&subject=management",
        },
        {
          name: t("study.hsc.subjects.finance"),
          path: "/study/exam?group=hsc&subject=finance",
        },
        {
          name: t("study.hsc.subjects.business"),
          path: "/study/exam?group=hsc&subject=business",
        },
        {
          name: t("study.hsc.subjects.marketing"),
          path: "/study/exam?group=hsc&subject=marketing",
        },
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-geometric-light dark:bg-geometric-dark py-16 px-4">
      <Helmet>
        {lang === "bn" ? (
          <>
            <title>
              এইচএসসি কর্নার - কাফআহ | বিজ্ঞান, মানবিক ও বাণিজ্য গ্রুপ
            </title>
            <meta
              name="description"
            ...
            <meta
              ...
              content="এইচএসসির সব গ্রুপের জন্য অধ্যায়ভিত্তিক মডেল টেস্ট।"
            />
          </>
        ) : (
          <>
            <title>
              HSC Corner - Kafa'ah | Science, Arts & Commerce Groups
            </title>
            <meta
              name="description"
            ...
            <meta
              property="og:description"
              content="Chapter-wise model tests for all HSC groups."
            />
          </>
        )}
        <meta
          property="og:url"
          content="https://kafaahbd.github.io/kafaahbd/study/hsc"
        />
      </Helmet>
