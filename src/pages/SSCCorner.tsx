  ...
  const groups: Group[] = [
    {
      ...
      subjects: [
        {
          name: t("study.subjects.bangla"),
          path: "/study/exam?group=ssc&subject=bangla",
        },
        {
          name: t("study.subjects.english"),
          path: "/study/exam?group=ssc&subject=english",
        },
        {
          name: t("study.subjects.ict"),
          path: "/study/exam?group=ssc&subject=ict",
        },
        {
          name: t("study.subjects.math"),
          path: "/study/exam?group=ssc&subject=math",
        },
        {
          name: t("study.subjects.islam"),
          path: "/study/exam?group=ssc&subject=islam",
        },
      ],
    },
    {
      ...
      subjects: [
        {
          name: t("study.subjects.physics"),
          path: "/study/exam?group=ssc&subject=physics",
        },
        {
          name: t("study.subjects.chemistry"),
          path: "/study/exam?group=ssc&subject=chemistry",
        },
        {
          name: t("study.subjects.biology"),
          path: "/study/exam?group=ssc&subject=biology",
        },
        {
          name: t("study.subjects.bgs"),
          path: "/study/exam?group=ssc&subject=bgs",
        },
      ],
    },
    {
      ...
      subjects: [
        {
          name: t("study.subjects.history"),
          path: "/study/exam?group=ssc&subject=history",
        },
        {
          name: t("study.subjects.civics"),
          path: "/study/exam?group=ssc&subject=civics",
        },
        {
          name: t("study.subjects.geography"),
          path: "/study/exam?group=ssc&subject=geography",
        },
        {
          name: t("study.subjects.bgs"),
          path: "/study/exam?group=ssc&subject=bgs",
    ...
    },
    {
      ...
      subjects: [
        {
          name: t("study.subjects.accounting"),
          path: "/study/exam?group=ssc&subject=accounting",
        },
        {
          name: t("study.subjects.business"),
          path: "/study/exam?group=ssc&subject=business",
        },
        {
          name: t("study.subjects.finance"),
          path: "/study/exam?group=ssc&subject=finance",
        },
        {
          name: t("study.subjects.bgs"),
          path: "/study/exam?group=ssc&subject=bgs",
    ...
    },
    {
      ...
      subjects: [
        {
          name: t("study.subjects.highermath"),
          path: "/study/exam?group=ssc&subject=highermath",
        },
        {
          name: t("study.subjects.agriculture"),
          path: "/study/exam?group=ssc&subject=agriculture",
        },
        {
          name: t("study.subjects.health"),
          path: "/study/exam?group=ssc&subject=health",
        },
      ],
    },
  ];
        ...
        {lang === "bn" ? (
          <>
            ...
            <meta
              ...
              content="এসএসসির সব গ্রুপের জন্য অধ্যায়ভিত্তিক মডেল টেস্ট।"
            />
          </>
        ) : (
          <>
            ...
            <meta
              property="og:description"
              content="Chapter-wise model tests for all SSC groups."
            />
          </>
        )}
        <meta
          property="og:url"
          content="https://kafaahbd.github.io/kafaahbd/study/ssc"
        />
      </Helmet>
