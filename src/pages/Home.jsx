    ...
    <div className="bg-geometric-light dark:bg-geometric-dark">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          <ScrollAnimation className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
            <h2 className="text-3xl font-bold mb-4 text-green-700 dark:text-green-400">{t('home.mission.title')}</h2>
            <p className="text-gray-700 dark:text-gray-300">{t('home.mission.text')}</p>
          </ScrollAnimation>
          <ScrollAnimation className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg">
            <h2 className="text-3xl font-bold mb-4 text-green-700 dark:text-green-400">{t('home.vision.title')}</h2>
      ...
      <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white">{t('home.services.title')}</h2>
            ...
            {services.map((service, idx) => (
              <ScrollAnimation key={idx}>
                <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1 text-center">
                  <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">{service}</h3>
                </div>
              </ScrollAnimation>
            ))}
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white">{t('home.why.title')}</h2>
