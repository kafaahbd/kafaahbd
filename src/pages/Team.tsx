            ...
            <ScrollAnimation key={idx} delay={idx * 0.1} direction="up">
              ...
              >
                ...
                <div className="relative mb-6 md:mb-8">
                  <div className={`w-24 h-24 md:w-32 md:h-32 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br ${member.theme} flex items-center justify-center text-white shadow-2xl group-hover:rotate-6 transition-transform duration-500 overflow-hidden ring-4 ring-white dark:ring-gray-800`}>
                    {member.image ? (
